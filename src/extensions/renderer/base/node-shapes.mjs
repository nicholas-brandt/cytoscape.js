...
BRp.generateRoundPolygon = function (name, points) {
  return (this.nodeShapes[name] = {
    ...
    getOrCreateCorners: function (
      ...
      cornerRadius =
        cornerRadius === "auto"
          ? math.getRoundPolygonRadius(width, height)
          : cornerRadius;
    ...
    checkPoint: function (
      ...
      return math.pointInsideRoundPolygon(
        x,
        y,
        this.points,
        centerX,
  ...
  return (this.nodeShapes["cut-rectangle"] = this.nodeShapes["cutrectangle"] =
    {
      ...
      intersectLine: function (
        ...
        const cPts = this.generateCutTrianglePts(
          width + 2 * padding,
          height + 2 * padding,
          nodeX,
          nodeY,
      ...
      checkPoint: function (
        ...
        const cutTrianglePts = this.generateCutTrianglePts(
          width,
          height,
          centerX,
          centerY,
        ...
        return (
          math.pointInsidePolygonPoints(x, y, cutTrianglePts.topLeft) ||
...
BRp.generateBarrel = function () {
  return (this.nodeShapes["barrel"] = {
    ...
    intersectLine: function (
      ...
      const bPts = this.generateBarrelBezierPts(
        width + 2 * padding,
        height + 2 * padding,
        nodeX,
        nodeY,
      ...
      const approximateBarrelCurvePts = (pts) => {
        ...
        const m0 = math.qbezierPtAt(
          { x: pts[0], y: pts[1] },
          { x: pts[2], y: pts[3] },
          { x: pts[4], y: pts[5] },
          t0,
        );
        const m1 = math.qbezierPtAt(
          { x: pts[0], y: pts[1] },
          { x: pts[2], y: pts[3] },
          { x: pts[4], y: pts[5] },
          t1,
        );
        const m2 = math.qbezierPtAt(
          { x: pts[0], y: pts[1] },
          { x: pts[2], y: pts[3] },
          { x: pts[4], y: pts[5] },
          t2,
    ...
    checkPoint: function (
      ...
      const barrelCurvePts = this.generateBarrelBezierPts(
        width,
        height,
        centerX,
        centerY,
...
BRp.registerNodeShapes = function () {
  ...
  this.generatePolygon(
    "triangle",
    math.generateUnitNgonPointsFitToSquare(3, 0),
  );
  ...
  this.generatePolygon(
    "rectangle",
    math.generateUnitNgonPointsFitToSquare(4, 0),
  );
  ...
  this.generatePolygon(
    "pentagon",
    math.generateUnitNgonPointsFitToSquare(5, 0),
  );
  this.generateRoundPolygon(
    "round-pentagon",
    math.generateUnitNgonPointsFitToSquare(5, 0),
  ...
  this.generateRoundPolygon(
    "round-hexagon",
    math.generateUnitNgonPointsFitToSquare(6, 0),
  );

  this.generatePolygon(
    "heptagon",
    math.generateUnitNgonPointsFitToSquare(7, 0),
  );
  this.generateRoundPolygon(
    "round-heptagon",
    math.generateUnitNgonPointsFitToSquare(7, 0),
  ...
  this.generateRoundPolygon(
    "round-octagon",
    math.generateUnitNgonPointsFitToSquare(8, 0),
  );
