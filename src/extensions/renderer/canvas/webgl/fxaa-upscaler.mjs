...
export class FxaaUpscaler {
  ...
  updateOptions(options = {}) {
    if (options.subpixelQuality !== undefined)
      this.subpixelQuality = options.subpixelQuality;
    else if (!this.hasOwnProperty("subpixelQuality"))
    ...
    if (options.edgeThresholdMin !== undefined)
      this.edgeThresholdMin = options.edgeThresholdMin;
    else if (!this.hasOwnProperty("edgeThresholdMin"))
  ...
  apply(inputCanvas, outputCanvas) {
    ...
    if (this.debug) {
      ...
      const uniforms = {
        subpixelQuality: gl.getUniform(
          program,
          this.uniformLocations.subpixelQuality,
        ),
        edgeThreshold: gl.getUniform(
          program,
          this.uniformLocations.edgeThreshold,
        ),
        edgeThresholdMin: gl.getUniform(
          program,
          this.uniformLocations.edgeThresholdMin,
        ),
      };
