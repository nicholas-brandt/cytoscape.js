...
CRp.drawInscribedImage = function (context, img, node, index, nodeOpacity) {
  ...
  const nodeTW =
    nodeW +
    (getIndexedStyle(node, "background-width-relative-to", "value", index) ===
    "inner"
      ? 0
      : paddingX2);
  const nodeTH =
    nodeH +
    (getIndexedStyle(node, "background-height-relative-to", "value", index) ===
    "inner"
      ? 0
      : paddingX2);
  ...
  const posXUnits = getIndexedStyle(
    node,
    "background-position-x",
    "units",
    index,
  );
  const posXPfVal = getIndexedStyle(
    node,
    "background-position-x",
    "pfValue",
    index,
  ...
  const offXUnits = getIndexedStyle(
    node,
    "background-offset-x",
    "units",
    index,
  );
  const offXPfVal = getIndexedStyle(
    node,
    "background-offset-x",
    "pfValue",
    index,
  ...
  const posYUnits = getIndexedStyle(
    node,
    "background-position-y",
    "units",
    index,
  );
  const posYPfVal = getIndexedStyle(
    node,
    "background-position-y",
    "pfValue",
    index,
  ...
  const offYUnits = getIndexedStyle(
    node,
    "background-offset-y",
    "units",
    index,
  );
  const offYPfVal = getIndexedStyle(
    node,
    "background-offset-y",
    "pfValue",
    index,
