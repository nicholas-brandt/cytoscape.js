...
export const roundRectangleIntersectLine = (
  x,
  y,
  nodeX,
  nodeY,
  ...
  let cornerRadius =
    radius === "auto" ? getRoundRectangleRadius(width, height) : radius;
...
export const pointInsideRoundPolygon = (
  x,
  y,
  basePoints,
  centerX,
...
export const intersectLineEllipse = (
  x,
  y,
  centerX,
  centerY,
...
export const polygonIntersectLine = (
  x,
  y,
  basePoints,
  centerX,
...
export const roundPolygonIntersectLine = (
  x,
  y,
  basePoints,
  centerX,
